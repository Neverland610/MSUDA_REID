...
if __name__ == '__main__':
    ...
    parser.add_argument('-ds-2', '--dataset-source2', type=str, default='cuhk03',
                        choices=datasets.names())
    parser.add_argument('-ds-3', '--dataset-source3', type=str, default='cuhk03',
                        choices=datasets.names())
